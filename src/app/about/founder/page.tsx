  ...
  return (
    <div className="bg-[#F8F4EC] text-[#1B1F4B]">
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-[2rem] overflow-hidden aspect-[4/5] bg-[#EADCC2]">
                ...
                />
                <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-[#1B1F4B]/40 to-transparent" />
              </div>
              <p className="mt-5 text-xs tracking-[0.3em] uppercase text-[#2D5DA1] text-center">
                — In loving memory —
              </p>
            </div>
            ...
            <div className="lg:col-span-7 lg:pt-6">
              ...
              <h1 className="font-editorial text-[2.75rem] sm:text-[3.5rem] lg:text-[5.5rem] leading-[0.95] text-[#1B1F4B] mb-8">
                Dr. Raad Jajo,
                <br />
                <em className="italic text-[#2D5DA1]">M.D.</em>
              </h1>
              <p className="font-editorial text-2xl lg:text-[1.75rem] leading-[1.3] text-[#1B1F4B] mb-8">
                Founder of Jajo Psychiatry. A renowned psychiatrist who devoted
                more than two decades to the care of patients across metro
                Detroit.
              </p>
              <p className="text-[#1B1F4B]/60 leading-relaxed text-lg mb-8 max-w-xl">
              ...
              <p className="text-[#1B1F4B]/60 leading-relaxed text-lg max-w-xl">
      ...
      <section className="relative px-6 lg:px-10 py-20 overflow-hidden">
        <BotanicalSprig className="absolute -right-24 top-0 w-[480px] h-[480px] text-[#1B1F4B] opacity-[0.05] hidden lg:block rotate-180" />
        <div className="relative max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-4">
              ...
              <p className="hidden lg:block font-editorial text-[#1B1F4B] text-2xl leading-snug max-w-[18rem] mb-2">
                Dr. Raad Jajo,
                <br />
                <em className="italic text-[#2D5DA1]">M.D.</em>
              </p>
              ...
              <div className="hidden lg:block max-w-[16rem]">
                <div className="flex items-baseline gap-3 mb-4">
                  ...
                  <span className="text-xs text-[#1B1F4B]/55 leading-tight">
                    Years
                    <br />
                    in psychiatry
                  </span>
                </div>
                <div className="h-px bg-[#1B1F4B]/10 my-6" />
                <p className="font-editorial italic text-[#2D5DA1]/80 text-lg leading-snug">
                  &ldquo;Every individual is unique.&rdquo;
                </p>
              </div>
            </div>
            <div className="lg:col-span-8 space-y-6 text-[#1B1F4B]/70 leading-relaxed text-lg">
              <p className="font-editorial text-2xl lg:text-[2rem] leading-[1.3] text-[#1B1F4B]">
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="bg-[#1B1F4B] text-[#F8F4EC] rounded-[2rem] p-10 lg:p-20">
            <div className="max-w-3xl">
              <p className="text-xs tracking-[0.3em] uppercase text-[#4DC9F6] mb-6">
                — A Legacy of Care
              </p>
            ...
            <div className="mt-16 pt-12 border-t border-white/10 grid md:grid-cols-3 gap-10">
              <div>
                <p className="font-editorial text-5xl text-[#4DC9F6] mb-3">
                  20+
                </p>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-7 space-y-5 text-[#1B1F4B]/70 leading-relaxed text-lg">
              <p>
                ...
                daughter, <strong className="text-[#1B1F4B]">Shahad Jajo
              ...
              <div className="pt-4 flex flex-wrap gap-3">
                ...
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full border border-[#1B1F4B]/20 text-[#1B1F4B] text-sm hover:bg-[#1B1F4B]/5 transition-colors"
                >
                  About the practice
