        ...
        <div className="relative max-w-[1400px] mx-auto">
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start mt-4">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="font-editorial text-[2.75rem] sm:text-[3.5rem] lg:text-[5rem] leading-[0.98] text-[#1B1F4B] mb-6">
                Tell us how
                <br />
                <em className="italic text-[#2D5DA1]">we can help.</em>
              </h1>
              <p className="text-lg text-[#1B1F4B]/60 leading-relaxed max-w-xl mb-12">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-28">
              <div className="bg-[#1B1F4B] text-[#F8F4EC] rounded-[2rem] p-8 lg:p-10">
                ...
                <h3 className="font-editorial text-2xl lg:text-3xl mb-8 leading-[1.15]">
                  Multiple ways
                  <br />
                  <em className="italic text-[#4DC9F6]">to reach us.</em>
                </h3>
                ...
                <div className="space-y-6">
                  ...
                  >
                    <div className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center shrink-0 group-hover:border-[#4DC9F6] transition-colors">
                      <Phone className="h-4 w-4 text-[#4DC9F6]" />
                    </div>
                  ...
                  >
                    <div className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center shrink-0 group-hover:border-[#4DC9F6] transition-colors">
                      <Mail className="h-4 w-4 text-[#4DC9F6]" />
                    </div>
                    <div className="flex-1">
                      <p className="text-xs tracking-wider uppercase text-white/40 mb-1">
                        Email
                ...
                <div className="mt-8 pt-8 border-t border-white/10 space-y-3">
                  <Link
                    ...
                    className="flex items-center justify-between px-5 py-3 rounded-full bg-[#F8F4EC] text-[#1B1F4B] text-sm font-semibold"
                  >
                    Book Online
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-5">
              ...
              <h2 className="font-editorial text-4xl lg:text-5xl leading-[1.05] mb-6">
                Our office in
                <br />
                <em className="italic text-[#2D5DA1]">Farmington Hills.</em>
              </h2>
              <p className="text-[#1B1F4B]/60 mb-8 leading-relaxed">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-[#1B1F4B] text-[#F8F4EC] text-sm font-medium hover:bg-[#0E1238] transition-colors"
              >
            ...
            <div className="lg:col-span-7">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/3]">
                ...
                <iframe
                  ...
                  style={{
                    border: 0,
                    filter: "grayscale(100%) hue-rotate(190deg) saturate(35%) brightness(106%) contrast(92%)",
                  }}
                  allowFullScreen
                  loading="lazy"
                ...
                {/* Bottom info bar */}
                <div className="absolute bottom-0 left-0 right-0 bg-[#1B1F4B]/90 backdrop-blur-sm px-6 py-4 flex items-center justify-between">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#4DC9F6] text-[#1B1F4B] text-xs font-semibold hover:bg-white transition-colors"
                  >
