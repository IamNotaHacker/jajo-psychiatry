        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="relative rounded-[2rem] overflow-hidden">
            <div className="relative aspect-[16/11] md:aspect-[16/9] lg:aspect-[21/9]">
              ...
              />
              {/* Blue/cyan color overlay for cooler tone */}
              <div
        ...
        <div className="relative max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-5 auto-rows-[220px] md:auto-rows-[200px] lg:auto-rows-[260px]">
            ...
            <Link
              ...
              className="lg:col-span-5 rounded-2xl p-6 lg:p-8 flex flex-col justify-between group cursor-pointer text-white"
            ...
            <Link
              ...
              className="lg:col-span-3 rounded-2xl p-6 flex flex-col justify-between cursor-pointer group"
            ...
            <Link
              ...
              className="lg:col-span-2 rounded-2xl p-5 flex flex-col justify-between cursor-pointer group"
