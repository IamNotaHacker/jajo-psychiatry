          ...
          <div className="space-y-px bg-[#1F1A14]/10 rounded-2xl overflow-hidden">
            {SERVICES.map((service) => {
              ...
              return (
                ...
                >
                  <span className="font-editorial text-xl text-[#1F1A14]/30 shrink-0 w-10">
                    {details?.num}
                  </span>
                  <div className="flex-1 grid lg:grid-cols-12 gap-4">
                    ...
                    <p className="lg:col-span-7 text-[#1F1A14]/60 leading-relaxed">
                      {service.shortDescription}
                    </p>
                    <div className="lg:col-span-1 flex justify-end items-start">
                      <Plus className="h-5 w-5 text-[#1F1A14]/40 group-hover:rotate-90 transition-transform" />
                    </div>
                  </div>
                </Link>
              );
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-8">
              ...
              <p className="text-[#1F1A14]/60 leading-relaxed max-w-2xl mb-4">
              ...
              <p className="text-[#1F1A14]/60 leading-relaxed max-w-2xl">
        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {CONDITIONS.map((condition) => (
              ...
              >
                <span className="font-editorial text-xl text-[#1F1A14]">
                  {condition.title}
                </span>
